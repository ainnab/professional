  ...
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <!--div class="row row-xs wd-xl-80p">
        <div class="col-sm-6 col-md-3"><button class="btn btn-success btn-with-icon btn-block" onclick="location.href='manage_voucher.php'"><i class="typcn typcn-edit"></i>ADD NEW VOUCHER</button></div>
            ...
            <div class="card">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-25p">Voucher</th>
                  <th class="wd-20p">Date</th>
                  <th class="wd-15p">Terms</th>
                  <th class="wd-20p">#Courses</th>
                  <th class="wd-20p">Redemptions</th>
                  <th class="wd-20p">Expires</th>
...
$i++;
               ...
               <td class="text-center">
                                        <form method="post" action="save_admin_voucher.php?id=<?php echo $id;?>">
        <?php if ($status =='') { ?><input type="submit" name="action"  value="Approved" class="button"  /> <?php } ?>
          <?php if ($status =='APPROVED') { ?><input type="submit" name="action"  value="Approved" class="button" hidden /><?php } ?>
