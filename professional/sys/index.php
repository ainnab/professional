...
.az-card-signin {
  ...
  <?php 
    ...
    $_SESSION['ic']=$row['stud_ic'];
      ...
      if ($role =='student' && $app =='1' && $status == 'Applied'){
        header("Location:dashboard2.php");
      }
      if ($role =='student' && $app =='2' && $status == 'Applied'){
        header("Location:dashboard4.php");
      }
      if ($role =='student' && $app =='0' && $status == 'Applied'){
        header("Location:dashboard_guideline.php");
      }
      if ($role =='student' && $app =='2' && $status == 'Submitted'){
        header("Location:view_submission.php");}
        if ($role =='student' && $app =='1' && $status == 'Submitted'){
          header("Location:view_submission.php");}
