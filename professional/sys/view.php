        ...
        <div class="card card-dashboard-seven">
          ...
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Personal Information</h2>
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <input id="firstname" class="form-control" name="name" placeholder="Enter firstname" value="<?php echo $data['stud_name']; ?>" type="text" style="text-transform:uppercase" readonly>
                </div><!-- form group -->
            </div><!-- col -->
            </div><!-- row -->
            <div class="row row-sm">
            <div class="col-md-5 col-lg-4">
                ...
                <input id="firstname" class="form-control" name="ic" type="text" value="<?php echo $ic; ?>" readonly>
                </div><!-- form group -->
            </div><!--col-->
            ...
            <div class="col-md-5 col-lg-4">
                ...
                <input id="email" class="form-control" name="email" type="text" value="<?php echo $data['stud_email']; ?>" readonly>
                </div><!-- form group -->
            </div><!-- col -->
            <div class="col-md-5 col-lg-4 mg-t-20 mg-md-t-0">
                <div class="form-group">
                <label class="form-control-label">Home Tel Number: </label>
                <input id="hometel" class="form-control" name="hometel" value="<?php echo $data['stud_home']; ?>" type="text" readonly>
                </div><!-- form group -->
            </div><!--col-->
            <div class="col-md-5 col-lg-4">
                <div class="form-group">
                <label class="form-control-label">Phone: </label>
                <input id="phone" class="form-control" name="phone" type="text" value="<?php echo $data['stud_phone']; ?>" readonly>
                </div><!-- form group -->
            </div><!-- col -->  
            </div><!-- row -->
            <div class="row row-sm">
            ...
            <div class="col-lg-3">
                ...
                <label class="form-control-label">Date of Birth: </label>
                    ...
                    <input id="dateMask" type="text" name="dob" class="form-control" value="<?php echo $data['dob']; ?>" placeholder="MM/DD/YYYY" readonly>
                    </div><!-- input-group -->
                </div><!-- form group -->
            </div><!-- col-4 -->
            </div><!-- row -->
            ...
            <div class="col-md-12 col-lg-12">
                ...
                <input id="" class="form-control" style="text-transform:uppercase" name="add1" placeholder="Enter Address1" value="<?php echo $data['add1']; ?>" type="text" READONLY>
                </div><!-- form group -->
            </div><!-- col -->
            </div><!-- row -->
            <div class="row row-sm">
            <div class="col-md-12 col-lg-12">
                ...
                <input id="" class="form-control" style="text-transform:uppercase" name="add2" placeholder="Enter Address2" value="<?php echo $data['add2']; ?>" type="text" readonly>
                </div><!-- form group -->
            </div><!-- col -->
            </div><!-- row -->
            <div class="row row-sm">
            <div class="col-md-5 col-lg-4">
                ...
                <input id="city" class="form-control" name="city" type="text" value="<?php echo $data['city']; ?>" readonly>
                </div><!-- form group -->
            </div><!-- col -->
            <div class="col-md-5 col-lg-4 mg-t-20 mg-md-t-0">
                <div class="form-group">
                <label class="form-control-label">Postcode: </label>
                <input id="" class="form-control" name="postcode" value="<?php echo $data['postcode']; ?>" type="text" readonly>
                </div><!-- form group -->
            </div><!--col-->
            <div class="col-lg-4 mg-t-20 mg-lg-t-0">
                <div class="form-group">
...
<div class="row row-sm">
  <div class="col-md-12 col-lg-12">
    <div class="form-group">
      ...
      <input id="namep1" class="form-control" style="text-transform:uppercase" name="namep1" placeholder="Enter firstname" value="<?php echo $data2['p1_name']; ?>" type="text" readonly>
    </div><!-- form group -->
  </div><!-- col -->
</div><!-- row -->
<div class="row row-sm">
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
      <label class="form-control-label">IC number/passport: </label>
      <input id="icp1" class="form-control" name="icp1" placeholder="Enter IC parent1/guardian" type="text" value="<?php echo $data2['p1_ic']; ?>" readonly>
    </div><!-- form group -->
  </div><!--col-->
  <div class="col-lg-4 mg-t-20 mg-lg-t-0">
    <div class="form-group">
...
<div class="row row-sm">
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
      <label class="form-control-label">Email: </label>
      <input id="emailp1" class="form-control" name="emailp1" type="text" value="<?php echo $data2['p1_email']; ?>" readonly>
    </div><!-- form group -->
  </div><!-- col -->
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
      <label class="form-control-label">Phone: </label>
      <input id="phonep1" class="form-control" name="phonep1" type="text" value="<?php echo $data2['p1_phone']; ?>" readonly>
    </div><!-- form group -->
  </div><!-- col -->  
</div><!-- row -->
<div class="row row-sm">
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
    <label class="form-control-label">Marital Status: </label>
      <select name="maritalp1" class="form-control select2" disabled>
      <?php while ($mar = mysqli_fetch_array($all_marital,MYSQLI_ASSOC)):; ?>
...
<div class="row row-sm">
  <div class="col-lg-8 mg-t-20 mg-lg-t-0">
    <div class="form-group">
      ...
      <select name="relationp1" class="form-control select2" disabled>
  ...
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
      <label class="form-control-label">No OKU: <span class="tx-danger">if relatable</span></label>
      <input id="nookup1" class="form-control" name="nookup1" type="text" value="<?php echo $data2['p1_nooku']; ?>" readonly>
    </div><!-- form group -->
  </div><!-- col -->
</div><!-- row -->
<p class="mg-b-20"></p>
...
<div class="row row-sm">
  <div class="col-md-12 col-lg-12">
    <div class="form-group">
      ...
      <input id="namep1" class="form-control" style="text-transform:uppercase" name="namep2" placeholder="Enter firstname" value="<?php echo $data2['p2_name']; ?>" type="text" readonly>
    </div><!-- form group -->
  </div><!-- col -->
</div><!-- row -->
<div class="row row-sm">
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
      <label class="form-control-label">IC number/passport: </label>
      <input id="icp1" class="form-control" name="icp2" placeholder="Enter IC parent2" type="text" value="<?php echo $data2['p2_ic']; ?>" readonly>
    </div><!-- form group -->
  </div><!--col-->
  <div class="col-lg-4 mg-t-20 mg-lg-t-0">
    <div class="form-group">
...
<div class="row row-sm">
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
      <label class="form-control-label">Email: </label>
      <input id="emailp2" class="form-control" name="emailp2" type="text" value="<?php echo $data2['p2_email']; ?>" readonly>
    </div><!-- form group -->
  </div><!-- col -->
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
      <label class="form-control-label">Phone: </label>
      <input id="phonep1" class="form-control" name="phonep2" type="text" value="<?php echo $data2['p2_phone']; ?>" readonly>
    </div><!-- form group -->
  </div><!-- col -->  
</div><!-- row -->
<div class="row row-sm">
...
<div class="row row-sm">
  ...
  <div class="col-md-5 col-lg-4">
    <div class="form-group">
      <label class="form-control-label">No OKU: <span class="tx-danger">if relatable</span></label>
      <input id="nookup2" class="form-control" name="nookup2" type="text" value="<?php echo $data2['p2_nooku']; ?>" readonly>
    </div><!-- form group -->
  </div><!-- col -->
</div><!-- row -->
<p class="mg-b-20"></p>
...
<h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Academic Information</h2>
    ...
    <div class="col-md-12 col-lg-6">
        ...
        <input id="" class="form-control" name="ipta" placeholder="Enter IPTA Name" value="<?php echo $data3['ipta']; ?>" type="text" style="text-transform:uppercase" readonly>
        </div><!-- form group -->
    </div><!-- col -->
    </div><!-- row -->  
    <div class="row row-sm">
    <div class="col-md-12 col-lg-6">
        ...
        <input id="" class="form-control" name="cgpa" placeholder="Enter CGPA" value="<?php echo $data3['cgpa']; ?>" type="text" style="text-transform:uppercase" readonly>
        </div><!-- form group -->
    </div><!-- col -->
    <div class="col-md-12 col-lg-6">
        <div class="form-group">
        <label class="form-control-label">MUET: </label>
        <input id="" class="form-control" name="muet" placeholder="Enter Band MUET" value="<?php echo $data3['muet']; ?>" type="number" style="text-transform:uppercase" readonly>
        </div><!-- form group -->
    </div><!-- col -->
    </div><!-- row -->
    <hr/>
    ...
    <div class="col-md-12 col-lg-6">
        ...
        <input id="" class="form-control" name="spmnumber" placeholder="Enter SPM Number" value="<?php echo $data3['spm_number']; ?>" type="text" style="text-transform:uppercase" readonly>
        </div><!-- form group -->
    </div><!-- col -->
    <div class="col-md-12 col-lg-6">
        <div class="form-group">
        <label class="form-control-label">Year of SPM: </label>
        <input id="" class="form-control" name="spmyear" placeholder="Enter Year of SPM" value="<?php echo $data3['spm_year']; ?>" type="number" onKeyPress="if(this.value.length==4) return false;" style="text-transform:uppercase" readonly>
        </div><!-- form group -->
    </div><!-- col -->
    </div><!-- row -->
    <div class="row row-sm">
    ...
    <div class="col-md-12 col-lg-6">
        ...
        <input id="" class="form-control" name="schoolname" placeholder="Enter School Name" value="<?php echo $data3['school_name']; ?>" type="text" style="text-transform:uppercase" readonly>
        </div><!-- form group -->
    </div><!-- col -->
    </div><!-- row -->
    <p class="mg-b-30"></p>
          ...
          <p class="mg-b-20">Elective Subjects</p>
            ...
            <?php if (mysqli_num_rows($result) > 0) { ?>
              <?php $i=0; $j=1; while($row = mysqli_fetch_array($result)) { ?>
                            ...
                            <td><?php echo $row["spm_grade"]; ?></td></tr>
            <?php $i++;  } ?>
              </tbody>
...
<div class="container">
            ...
            <td><a href="Uploaded_Files/<?php echo $row['location']; ?>"><?php echo htmlentities($row['location']);?></td>
            </tr>
            <?php
            }
	...
	<center><input type="button" onclick="printInvoice();" value="Print"></center>
