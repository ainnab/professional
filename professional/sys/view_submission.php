    ...
    <div class="az-sidebar">
      ...
      <div class="az-sidebar-body">
        <ul class="nav">
          ...
          <a href="header_diploma.php" class="nav-link"><i class="typcn typcn-clipboard"></i>Application</a>
          </li>
 ...
 <li class="nav-item show">
    ...
    <div class="az-content az-content-dashboard-two">
      ...
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Submission is completed</h2>
        </div>
