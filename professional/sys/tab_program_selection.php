        ...
        <li class="nav-label">Main Menu</li>
          ...
          <li class="nav-item show current">
            ...
            <ul class="nav-sub">
              ...
              <li class="nav-sub-item  "><a href="tab_liststudent_agent.php" class="nav-sub-link ">List Student</a></li>
      ...
      <div class="col-md-12 col-lg-12 col-xl-12">
        <div class="card card-dashboard-seven">
          <div class="card-body">
              ...
              <div>
            <div class="tab">
      <button class="tablinks" onclick="openCity(event, 'Application')" id="defaultOpen">Application</button>
