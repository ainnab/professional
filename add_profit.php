...
?>
 ...
 <form id="profit_form" action="save_profit.php" method="POST" enctype="multipart/form-data" >
     <h2 class="az-content-title">Contract Information</h2>

   

             
          <div class="az-content-label mg-b-5">Earns by UMP Mooc</div>
          ...
          <div class="row row-sm">
            ...
            <div class="form-group mg-b-0">
              ...
              <input class="form-control"   required type="text" name="earn_mooc">
              </div><!-- card -->
          ...
          <br>
          <div class="az-content-label mg-b-5">Earns by UMP Institution</div>
          <div class="row row-sm">
           
            <div class="form-group mg-b-0">
              <div class="card card-body bg-indigo tx-white bd-0">
              <input class="form-control"   required type="text" name="earn_inst">
              </div><!-- card -->
...
<br>
      <p>  <div class="form-group has-success mg-b-0">ID
                  <input class="text" name="profit_id"  required/> 
