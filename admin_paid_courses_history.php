    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8">PURCHASE HISTORY OF PAID COURSES</h2>
          </div>
            ...
            <div class="card">
              <div class="card-header">
                        ...
                        <div class="col-md-5">
                            ...
                            <option value="FKEE">FAKULTI KEJURUTERAAN ELEKTRIK</option>
                            <option value="FKOM">FAKULTI KOMPUTER</option>
                           </select>
                        </div><!-- col -->
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-25p">COURSE ID</th>
                  <th class="wd-20p">COURSE NAME</th>
                  <th class="wd-15p">EARN</th>
