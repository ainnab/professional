            ...
            <div class="card">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-10p">UPDATE</th>
                  
                  <th class="wd-15p">COURSE OWNER STATUS</th>
                     <th class="wd-15p">INSTRUCTOR STATUS</th>
...
$i=0;
   $sql="SELECT cs.code as code ,cs.course_name as course_name,cs.new_date as new_date,cs.status as status ,ow.status as teacher

   FROM cs_owner as cs 

   left outer join ownership_instructor as ow on ow.code=cs.code



   where cs.login_name='$login_session'";

                    $app=mysqli_query($dbconfig2,$sql);
...
//$cid = current(explode(",", $id));

 $course = $row1['course_name'];
  $date = $row1['new_date'];

   $status = $row1['status'];
   $status1 = $row1['teacher'];
$courseName = current(explode(",", $course));
$sta = current(explode(",", $status));
$sta1 = current(explode(",", $status1));
...
<td><?php echo  $date;?></td>
                     ...
                     <td><?php if ($sta =='need review') { ?><div class="col-sm-3 mg-t-10 mg-sm-t-0">
                  
                      <span class="badge badge-pill badge-warning">Need Review</span>
                  </div>
                    
                  <?php } ?>

<?php if ($sta =='accepted') { ?><div class="col-sm-3 mg-t-10 mg-sm-t-0">
                  ...
                  <?php } ?> </td>
                   ...
                   <td><?php if ($sta1 =='need review') { ?><div class="col-sm-3 mg-t-10 mg-sm-t-0">
...
<?php if ($sta1 =='accepted') { ?><div class="col-sm-3 mg-t-10 mg-sm-t-0">
                  ...
                  <td><div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="coordinator_co_update.php?id=<?php echo $id;?>"><i class="dw dw-eye"></i> Course Owner</a>
                        <a class="dropdown-item" href="coordinator_inst_update.php?id=<?php echo $id;?>"><i class="dw dw-eye"></i> Instructor</a>
                      </div>
                    </div></td>
