    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8">COURSE COORDINATOR INFORMATION</h2>
          </div>
...
$sqlb="SELECT u.firstname,u.lastname,cc.name,cc.path,u.department as inst,u.email FROM `mdl_course_categories` as cc  inner join mdl_context as cnt on cnt.instanceid=cc.id inner join mdl_role_assignments as ra on ra.contextid=cnt.id inner join mdl_role as r on r.id=ra.roleid inner join mdl_user as u on u.id=ra.userid where r.id=2 and cc.path LIKE '/".$userRow["inst_id"]."' ";
