    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8">Instructor Ownership</h2>
      ...
      <div class="col-xl-12 mg-t-15 mg-t-20">
        ...
        $sqlb="SELECT distinct u.firstname as fname ,u.username ,u.lastname as lname ,cats.path,c.fullname,cats.name ,ra.roleid,u.department FROM mdl_course AS c LEFT JOIN mdl_context AS ctx ON c.id = ctx.instanceid JOIN mdl_role_assignments AS ra ON ra.contextid = ctx.id join mdl_user as u on u.id=ra.userid JOIN mdl_course_categories AS cats ON c.category = cats.id where ra.roleid='9' and ctx.contextlevel='50' and c.id='$course_id' ";
...
$uname =$var['username'];
  ...
  $sqlc"SELECT instructor,course_name,code,weight FROM ownership_instructor where instructor='$uname' and code='$course_id' ";
