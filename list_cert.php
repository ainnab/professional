    ...
    <?php include 'topmenu.php';?>
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8">COMPETENCY CERTIFICATE</h2>
      ...
      <div class="az-content-body">
        <div class="row row-sm">
		  ...
		  <div class="col-xl-12 mg-t-15 mg-t-20">
            ...
            <a href="https://ilmu.ump.edu.my/ILMU/admin/tool/certificate/index.php" class="btn btn-primary" >VERIFY CERTIFICATE HERE</a>
          </div><!-- pd-y-30 -->
              </div><!-- card-header -->
              <div class="card-body">
              ...
              <thead>
                <tr>
                  <th class="wd-25p">Certificate ID</th>
                  <th class="wd-15p">Course</th>
                  <th class="wd-10p">Enrolled date</th>
...
$i = 0;
  ...
  $query = "SELECT distinct cert.code,c.fullname FROM `mdl_tool_certificate_issues` as cert inner join mdl_user as u on u.id=cert.userid inner join mdl_course as c on c.id=cert.courseid where  u.username='$login_session'";
...
$i++;
  ...
  $sql2="SELECT FROM_UNIXTIME(ue.timestart) as enrol_date,en.cost,co.id FROM `mdl_user_enrolments` as ue join mdl_enrol as en on en.id=ue.enrolid join mdl_course as co on co.id=en.courseid join mdl_user as u on u.id=ue.userid where co.fullname='$course'
...
WHERE   u.username='$login_session' and p.timecompleted!='' and c.fullname='$course'
