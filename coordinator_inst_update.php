...
?>
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
   ...
   <form action="update_inst_co.php" method="post">
              <div class="card-body">
...
$cid = $_REQUEST['id'];
                    ...
                    $sql3="SELECT * FROM `ownership_instructor` where code='$cid' ";
...
echo "</td>";
             ...
             echo '<input type="hidden" value="'.$cid.'" name="cid" >';
              ...
              echo "<td>" ;
              echo '<input type="text" name="inst[]" value="'.$co[$indx].'" readonly>';
              echo "</td>";
              echo "<td>" ;
