    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8">Payout Reporting by Student</h2>
      ...
      <div class="col-xl-12 mg-t-15 mg-t-20">
            <div class="card">
              <div class="card-header">
                <h6 class="card-title tx-14 mg-b-5">List of Student by Course</h6>
          ...
          <table id="example1" class="table table-striped mg-b-0">
            ...
            <th class="wd-20p">Voucher</th>
            <th class="wd-20p">Payment</th>
            <th class="wd-20p">Pay. Type</th>
            <th class="wd-20p">Date</th>
            <th class="wd-20p">Ownership distribution</th>
            </tr>
            </thead>
           <?php
          ...
          $payment_type = 'PAYPAL';
          $firstname = $userRow2['firstname'];
          $lastname = $userRow2['lastname'];
          ?>
            <tbody>
            ...
            <td><?php echo $purchase_date?></td>
             <td><div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="coordinator_co_update.php?id=<?php echo $id;?>"><i class="dw dw-eye"></i> Manager</a>
                        <a class="dropdown-item" href="coordinator_inst_update.php?id=<?php echo $id;?>"><i class="dw dw-eye"></i> Coordinator</a>
                        <a class="dropdown-item" href=""><i class="dw dw-eye"></i> Course Owner</a>
                        <a class="dropdown-item" href=""><i class="dw dw-eye"></i> Instructor</a>
                      </div>
                    </div></td>
          </tr>
          <?php } ?>
