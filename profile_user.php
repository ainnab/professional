...
where mdl_user.username = '$login_session' ";*/
 ...
 $sql_query="SELECT u.username as username,u.firstname,u.lastname, u.email, u.institution as institution ,r.name as rolename, ra.roleid,ra.userid,u.phone1
    ...
    <?php include 'topmenu.php';?>
      ...
      <div class="az-footer ht-40">
        <div class="container-fluid pd-t-0-f ht-100p">
          <span>&copy;ILMUPLUS DEVELOPED BY UMP ADVANCED</span>
        </div><!-- container -->
      </div><!-- az-footer -->
    </div><!-- az-content -->
