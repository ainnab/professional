  ...
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="col-xl-12 mg-t-15 mg-t-20">
        ...
        $sqlb="SELECT distinct u.username as username FROM `mdl_course_categories` as cc inner join mdl_context as cnt on cnt.instanceid=cc.id inner join mdl_role_assignments as ra on ra.contextid=cnt.id inner join mdl_role as r on r.id=ra.roleid inner join mdl_user as u on u.id=ra.userid where r.id=2 and cc.path LIKE '/".$userRow["inst_id"]."' ";


$mysqlb = mysqli_query($dbconfig,$sqlb);
$var = mysqli_fetch_array($mysqlb,MYSQLI_ASSOC);

$coordinator = $var['username'];
          ...
          ?>
            ...
            <td><?php echo $name?> <?php echo $lastname?></td>
            <td>RM <?php echo $total=$enrol*50/100  ?></td>
