    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8">List Student</h2>
          </div>
      ...
      <div class="col-xl-12 mg-t-15 mg-t-20">
        ...
        $sql_query2="SELECT distinct c.id,c.fullname,u.username as student,us.username ,tra.roleid,usr.username as teacher ,ra.roleid,usr.institution as inst FROM mdl_course AS c LEFT JOIN mdl_context AS ctx ON c.id = ctx.instanceid JOIN mdl_role_assignments AS lra ON lra.contextid = ctx.id JOIN mdl_role_assignments AS tra ON tra.contextid = ctx.id JOIN mdl_role_assignments AS ra ON ra.contextid = ctx.id join mdl_user as u on u.id=lra.userid join mdl_user as us on us.id=tra.userid join mdl_user as usr on usr.id=ra.userid WHERE lra.roleid=5 and ra.roleid=9 and tra.userid ='$userId' and c.id='$cid'";
        //echo $sql_query2;
