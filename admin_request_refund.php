    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8">REFUND</h2>
              ...
              <thead>
                <tr>
                  ...
                  <th class="">STUDENT NAME</th>
                   <th class="">ENROLLED DATE</th>
                  <th class="">REFUND DATE</th>
...
$i = 0;
                    ...
                    $sql3="SELECT *from refund_payment";
...
$i++;
                ...
                <tr>
                 <td class="table-plus"><?php echo $i;?></td>
                  ...
                  <td><form method="post"   action="admin_refund.php?id=<?php echo $id;?>" >
