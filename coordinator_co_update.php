...
?>
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
   ...
   <form action="update_ownership_co.php" method="post">
              <div class="card-body">
...
$i++;
                      ...
                      $cid = $row1['code'];
                      $status = $row1['status'];
                      $leader = $row1['leader_co'];
                        
 //$leader= mysqli_real_escape_string($dbconfig2,$leader);
...
echo "</td>";
             ...
             echo '<input type="hidden" value="'.$cid.'" name="cid" >';
              ...
              echo "</td>";
              echo "<td>" ;
              echo '<input type="text" name="weight[]" value="'.$weight[$indx].'" >';
              echo "</td>";
               echo "<td>" ;
              echo '<input type="text" name="remarks[]" value="'.$remarks[$indx].'" >';
              echo "</td>";
...
echo "<input type='checkbox' name='leader[1]' value='".$leader[$indx]."' checked disabled>";
...
echo "<input type='checkbox' name='leader[1]' value='".$leader[$indx]."' disabled >";
