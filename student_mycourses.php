    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            <h2 class="az-content-title mg-b-5 mg-b-lg-8">My Courses</h2>
            <p class="mg-b-0">Listing all enrolled free and paid courses</p>
          </div>
...
$i = 0;
                              ...
                              $query = "SELECT FROM_UNIXTIME(ue.timestart) as enrol_date,en.cost,co.fullname FROM `mdl_user_enrolments` as ue join mdl_enrol as en on en.id=ue.enrolid join mdl_course as co on co.id=en.courseid join mdl_user as u on u.id=ue.userid  where u.username='$login_session' ";
...
$i++;
                      ...
                      $course = $row1['fullname'];
                    
                                    $date = $row1['enrol_date'];
                                     $cost = $row1['cost'];
                     //$tec = $row1['tec'];
...
WHERE c.enablecompletion = 1 and  u.username='$login_session' and c.fullname='$course'

                                    ";
                                    //echo $sql2;
                                    $result3=mysqli_query($dbconfig,$sql4);
                                    $row3=mysqli_fetch_array($result3,MYSQLI_ASSOC);
                                    
                                    $complete = $row3['completed'];
                ...
                <tr>
                  ...
                  <td><?php echo $date;?></td>
                  <td><?php echo $complete;?>
                    


                    <?php if ($complete =='') { ?><label class="badge badge-warning">IN PROGRESS</label> <?php } ?>
                      <?php if ($complete =='NOT NULL') { ?><label class="badge badge-success">COMPLETE</label> <?php } ?>
                  </td>
          ...
          <!--td><span class="badge badge-pill badge-primary">Free</span></td-->
           <td><?php echo $cost;?>
                    ...
                    <?php if ($cost =='') { ?><label class="badge badge-info">FREE</label> <?php } ?>
                      <?php if ($cost =='NOT NULL') { ?><label class="badge badge-success">PAID</label> <?php } ?></td>
