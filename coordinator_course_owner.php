...
while($parent = mysqli_fetch_array($mysqla)) {
  ...
  $sqlb="SELECT distinct c.id,c.fullname,ct.name ,ct.path,ct.visible,FROM_UNIXTIME(c.startdate) as startdate  FROM mdl_course_categories ct JOIN mdl_course_categories basecat ON basecat.id = ct.id 
...
<div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        <a class="dropdown-item" href="coordinator_sharing_ownership.php?id= '.$cid.'"><i class="dw dw-eye"></i> Course Owner</a>
                        <a class="dropdown-item" href="coordinator_instructor.php?id= '.$cid.'"><i class="dw dw-eye"></i> Instructor</a>
                      </div>
                    </div>';
