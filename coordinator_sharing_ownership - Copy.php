...
echo "<td>";
echo '<input type="checkbox"  name="check"  name="id[]" value="'.$i.'">';

echo "</td>
<td>";
echo '<input type="text" value="'.$courseName.'" name="courseName" readonly>';
...
echo "</td>";
echo "<td>";
echo '<input type="radio"  name="leader" value="on">';
"</td>";
echo "<td>";
echo '<div class="">
...
<?php } ?>
            ...
            <div class="col-md-12 text-center">
                <button type="submit" name="save" class="btn btn-purple" float="center" onclick="return confirm('Are you sure?')">SUBMIT</button>
                </div>
              </div><!-- card-body -->
