...
<label>UNIVERSITI MALAYSIA PAHANG</label>
   ...
   <div class="form-group mg-b-0">
                ...
                <input type="text" name="set" class="form-control wd-sm-250"  required>
              </div>
<br>
            ...
            <div class="d-sm-flex">
              <div id="slWrapper" class="parsley-select wd-sm-250">
                <select class="form-control select2" name="contract"data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" required>
            ...
            <div class="d-sm-flex">
              <div id="slWrapper" class="parsley-select wd-sm-250">
                <input type="text" name="fakulti" class="form-control wd-sm-250"  required>
                <!--select class="form-control select2" name="fakulti" data-placeholder="Choose one" data-parsley-class-handler="#slWrapper" data-parsley-errors-container="#slErrorContainer" required>
                  <option label="Choose one"></option>
                   <?php
                            $sql4 = "SELECT *FROM fakulti";
                            $result4 = mysqli_query($dbconfig2, $sql4) or die("database error:". mysqli_error($dbconfig2));
                            while( $row4 = mysqli_fetch_assoc($result4) ) {
                                $id=$row4['id'];
                                $name=$row4['name'];
          ...
          <div class="row row-sm">
            ...
            <div class="form-group mg-b-0">
              ...
              <input class="form-control"  required type="text" name="institusi">
              </div><!-- card -->
          ...
          <div class="row row-sm">
            ...
            <div class="form-group mg-b-0">
              <div class="card card-body bg-indigo tx-white bd-0">
              <input class="form-control"   required type="text" name="coordinator">
              </div><!-- card -->
...
<br>
          ...
          <div class="row row-sm">
            ...
            <div class="form-group mg-b-0">
              <div class="card card-body bg-indigo tx-white bd-0">
              <input class="form-control"   required type="text" name="courseowner">
              </div><!-- card -->
...
<div class="az-content-label mg-b-5">Instructor</div>
          <div class="row row-sm">
            ...
            <div class="form-group mg-b-0">
              <div class="card card-body bg-indigo tx-white bd-0">
              <input class="form-control"   required type="text" name="instructor">
              </div><!-- card -->
...
<br>
            ...
            <div class="mg-t-20">
              <button type="submit" name="btn_profit" id="btn_profit" class="btn btn-az-primary pd-x-20" value="5">Validate Form</button>
