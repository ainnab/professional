            ...
            <div class="card">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-25p">COURSE OWNER</th>
              ...
              <tbody>
 <?php
        $sql_query2="SELECT c.id,c.fullname,u.username,count(lra.roleid) as student,us.username as cowner,tra.roleid,usr.username as teacher ,ra.roleid FROM mdl_course AS c LEFT JOIN mdl_context AS ctx ON c.id = ctx.instanceid JOIN mdl_role_assignments AS lra ON lra.contextid = ctx.id JOIN mdl_role_assignments AS tra ON tra.contextid = ctx.id JOIN mdl_role_assignments AS ra ON ra.contextid = ctx.id join mdl_user as u on u.id=lra.userid join mdl_user as us on us.id=tra.userid join mdl_user as usr on usr.id=ra.userid WHERE lra.roleid=5 and ra.roleid=9 and tra.roleid=3";
        //echo $sql_query2;
