...
?>
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
   ...
   <form action="save_inst_co.php" method="post">
              <div class="card-body">
...
echo "</td>"; 
 echo "<td>";
echo '<input type="text" value="'.$instructor.'" name="inst[]" readonly>';
echo "</td>";                 
