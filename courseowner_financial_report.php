      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            ...
            <p class="mg-b-0">How much you can earn as Course Owner</p>
          </div>
      ...
      <div class="az-content-body">
        <div class="row row-sm">
		  ...
		  <div class="col-xl-12 mg-t-15 mg-t-20">
            <div class="card">
              <div class="card-header">
                <h6 class="card-title tx-14 mg-b-5">Payment Record as Course Owner</h6>
              ...
              <tbody>
                <tr>
                  <td>MOOC.RT.200002</td>
                  <td>Feb,25,2020</td>
                  <td>myr100.00</td>
                  <td>MAYBANK2U</td>
                  <td>Completed</td>
				          <td><a href="courseowner_invoice.php"><span class="badge badge-pill badge-primary">Receipt</a></span>
                  </td>
                </tr>
                <tr>
                  <td>MOOC.RT.200003</td>
                  <td>Mac,25,2020</td>
                  <td>myr100.00</td>
                  <td>MAYBANK2U</td>
                  <td>Completed</td>
