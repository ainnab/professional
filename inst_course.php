  ...
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
    ...
    <div class="az-content az-content-dashboard-nine">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-20p">Ownership</th>
                   <th class="wd-20p">Verify Marks</th>
                </tr>
              </thead>
               <?php
      ...
      ?>
              <tbody>
                <tr>
                  <td><a href="list_student_inst.php?id=<?php echo $cid;?>"><?php echo $courseName;?></a></td>
                  <td><?php echo $date;?></td>
                  ...
                  <td><div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        ...
                        <a class="dropdown-item" href="inst_ownership.php?id=<?php echo $cid;?>"><i class="dw dw-eye"></i> Sharing ownership</a>
                      </div>
                    </div></td>
                    <td><div class="dropdown">
                      <a class="btn btn-link font-24 p-0 line-height-1 no-arrow dropdown-toggle" href="#" role="button" data-toggle="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        ...
                        <a class="dropdown-item" href="verify_studentsMark.php?id=<?php echo $cid;?>"><i class="dw dw-eye"></i> Verify</a>
                      </div>
                    </div></td>
                </tr>
              <?php } ?> 
