  ...
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="col-xl-12 mg-t-15 mg-t-20">
            <div class="card">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-20p">Ownership</th>
                </tr>
              </thead>
               <?php

        $sql_query1="SELECT distinct us.institution as inst,c.id,c.fullname,us.username,tra.roleid FROM mdl_course AS c 
        ...
        WHERE  us.username='$login_session' and  tra.roleid!=9 ";
        //echo $sql_query2;
        $res2=mysqli_query($dbconfig,$sql_query1);
        ...
        join mdl_user as us on us.id=tra.userid 
        join mdl_user as usr on usr.id=ra.userid 
        WHERE ra.roleid=9 and c.fullname='$courseName' ";
         $res=mysqli_query($dbconfig,$sql_query2);
                   ...
                   $sql1="SELECT count( lra.roleid )as student FROM mdl_course AS c LEFT JOIN mdl_context AS ctx ON c.id = ctx.instanceid JOIN mdl_role_assignments AS lra ON lra.contextid = ctx.id JOIN mdl_role_assignments AS tra ON tra.contextid = ctx.id join mdl_user as u on u.id=lra.userid join mdl_user as us on us.id=tra.userid WHERE lra.roleid=5 and  c.fullname='$courseName' and tra.userid ='$userId'";
        //echo $sql_query2;
                   ...
                   $sql2="SELECT FROM_UNIXTIME(ue.timestart) as enrol_date,en.cost FROM `mdl_user_enrolments` as ue join mdl_enrol as en on en.id=ue.enrolid join mdl_course as co on co.id=en.courseid join mdl_user as u on u.id=ue.userid where u.username='$login_session'
                                    ...
                                    $date = $row2['enrol_date'];
                                     $cost = $row2['cost'];
                                       ...
                                       $sql3="SELECT FROM_UNIXTIME(ue.timestart) as enrol_datet FROM `mdl_user_enrolments` as ue join mdl_enrol as en on en.id=ue.enrolid join mdl_course as co on co.id=en.courseid join mdl_user as u on u.id=ue.userid where u.username='$login_session'
                ...
                <tr>
                  ...
                  <td><div class="dropdown">
                      ...
                      <div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
                        ...
                        <a class="dropdown-item" href="cowner_ownership.php?id=<?php echo $cid;?>"><i class="dw dw-eye"></i> Sharing ownership</a>
                      </div>
                    </div></td>
                </tr>
              <?php } ?> 
