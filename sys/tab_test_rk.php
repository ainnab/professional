                                                ...
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="height" class="form-control" name="height"
                                                            type="text" value="<?php echo $data['height']; ?>" required>
                                                    </div><!-- form group -->
                                                </div><!-- col -->
                                                <div class="col-md-5 col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input id="weight" class="form-control" name="weight"
                                                            type="text" value="<?php echo $data['weight']; ?>" required>
                                                    </div><!-- form group -->
                                                </div><!-- col -->
                                            </div><!-- row -->
                                            <div class="row row-sm">
                                                            ...
                                                            ?>
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    ...
                                                                                    <a
                                                                                        href="edit_cert_rk.php?id=<?php echo $row['id']?>&stud_id=<?php echo $stud_id;?>"><button
                                                                                            name="update"
                                                                                            class="btn btn-primary btn-md">Edit</button></a>
                                                                                    <a href="save_rk_rope.php?id=<?php echo $row['id']?>&stud_id=<?php echo $stud_id;?>&deletecertRK=delete"
                                                                                        onClick="return confirm('Are you sure you want to delete?')"><button
                                                                                            type="submit"
                                                                                            name="deletecertRK"
                                                                                            id="btn-submit"
