...
$sql3 = "SELECT * FROM program_diploma where mode='BACHELOR' LIMIT $limitFrom, $limitTill ";
...
?>
 ...
 <hr class="mg-y-30">
        ...
        <button class="btn btn-outline-indigo ">  <a href="bach_exec_stud.php?page=<?=$page-1?>">Previous</a></button>
<button class="btn btn-outline-indigo"><a href="bach_exec_stud.php?page=<?=$page+1?>">Next</a></button>
</div>
</div>
