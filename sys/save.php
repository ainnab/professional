...
$mode = $_POST['mode'];
   ...
   $query = "INSERT INTO program_diploma (pg_name,pg_code,inst_name,keyin_date,adsName,mode,picDip,certificate) VALUES ('$progName','$progCode','$inst_name','$date_start','$adsName','$mode','$picDip','$certificate')";
