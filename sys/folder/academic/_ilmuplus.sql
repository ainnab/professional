...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 24, 2022 at 09:01 AM
...
CREATE TABLE `contract_info` (
  ...
  `institusi` varchar(1000) DEFAULT NULL,
...
INSERT INTO `contract_info` (`contract_id`, `institusi`, `start_date`, `end_date`, `status`) VALUES
('test_mooc1', 'uniten', '2022-03-01', '2022-03-01', 'Active');
...
--
-- Table structure for table `ownership_instructor`
--

CREATE TABLE `ownership_instructor` (
  `id` int(11) NOT NULL,
  ...
  `leader_inst` varchar(100) NOT NULL,
  `login_name` varchar(100) NOT NULL,
  `new_date` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Table structure for table `pemilikan_kerajaan`
--

CREATE TABLE `pemilikan_kerajaan` (
  `id` int(10) NOT NULL,
  `status_code` varchar(10) NOT NULL,
  `kod_pemilikan` varchar(10) NOT NULL,
  `nama_pemilikan` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `pemilikan_kerajaan`
--

INSERT INTO `pemilikan_kerajaan` (`id`, `status_code`, `kod_pemilikan`, `nama_pemilikan`) VALUES
(1, 'PS', '1', 'PERSEKUTUAN'),
(2, 'N', '1', 'NEGERI'),
(3, 'A', '1', 'AGENSI'),
(4, 'AS', '1', 'ANAK SYARIKAT'),
(5, 'SB', '2', 'SDN. BHD.'),
(6, 'BR', '2', 'BERHAD'),
(7, 'PT', '2', 'PERSATUAN'),
(8, 'LL', '2', 'LAIN-LAIN');
...
CREATE TABLE `profit` (
  `earn_mooc` varchar(100) DEFAULT NULL,
  `earn_ins` varchar(100) DEFAULT NULL,
  `id_profit` varchar(100) NOT NULL,
  `contract_info` varchar(100) DEFAULT NULL,
...
--
-- Table structure for table `profit_manager`
--

CREATE TABLE `profit_manager` (
  `no` int(11) NOT NULL,
  `ipd` varchar(100) NOT NULL,
  `contract` varchar(100) NOT NULL,
  `fakulti` varchar(100) NOT NULL,
  `institusi` int(100) NOT NULL,
  `coordinator` varchar(100) NOT NULL,
  `courseowner` varchar(100) NOT NULL,
  `instructor` varchar(100) NOT NULL,
...
--
-- Dumping data for table `profit_manager`
--

INSERT INTO `profit_manager` (`no`, `ipd`, `contract`, `fakulti`, `institusi`, `coordinator`, `courseowner`, `instructor`, `date_today`, `username`) VALUES
(7, 'ump.40.60', ' test_mooc2', 'KOMPUTER', 23, '35', '23', '15', '2022-04-01', 'alif');
...
INSERT INTO `refund_payment` (`id`, `username`, `name`, `email`, `ic_number`, `phone_no`, `my_course`, `course_name`, `cost`, `payment_id`, `receipt_no`, `choose_file`, `explanation`, `approved`, `date_refund`) VALUES
(16, 'tg20039', 'test', '', '951108065572', '0105744908', '217', '', '', '', 'txn56432', '', 'kkkkkkkkkkkkkkkkkkkkkkk', '', '2022-03-27');
...
(58, 'AQILAH SHAHIRAH', '980105241193', '$2y$04$L9BOND7XbjI/OpfDMH9uPuGyyKnvmFBfY3KeKvHKX7Mfna03PXZZe', 'nurulaqilah@umpadvanced.edu.my', '', '', '', '', '', '', '', '', '', '', '', '', 'student', 'Applied', 'sem1 22/23', '15/06/2022', '0', '', ''),
(59, 'ANIS', '002410112633', '$2y$04$iOtOv5aarTYgbuLILFG0Auv20ifxbtcIDbO9N91uE98wyj60Oe0i2', 'anisafrina76@gmail.com', '', '', '', '', '', '', '', '', '', '', '', '', 'student', 'Applied', 'sem1 22/23', '23/06/2022', '0', '', '');
...
CREATE TABLE `voucher` (
  ...
  `Limit_redem` varchar(10) NOT NULL,
  `Limit_total` varchar(100) NOT NULL,
...
INSERT INTO `voucher` (`id`, `voucher_name`, `voucher_type`, `discount`, `amount_off`, `Duration`, `Limit_redem`, `Limit_total`, `time_limit`, `course`, `date_redeem`, `date_update`, `username`, `status`) VALUES
(21, 'ILMU', '1', '50', '', 'Multiple Months', 'on', '2022-03-24', '30', 'HQA0011 - My FKOM', '2022-03-24', '2022-03-16', 'test', ''),
(22, 'ILMU', '1', '50', '', 'Multiple Months', 'on', '2022-03-24', '30', 'HQA0011 - My FKOM', '2022-03-24', '2022-03-16', 'test', ''),
(23, 'ILMU', '1', '50', '', 'Multiple Months', 'on', '2022-03-24', '30', 'HQA0011 - My FKOM', '2022-03-24', '2022-03-16', 'test', ''),
(24, 'ILMU', '1', '50', '', 'Once', 'on', '2022-03-09', '30', 'Pendidikan Moral Tahun 1', '2022-03-09', '2022-03-22', 'test', ''),
(25, 'ILMU', '2', '', '', 'Multiple Months', 'on', '2022-04-07', '30', 'Matematik Tahun 2', '2022-04-07', '2022-04-07', 'test', ''),
(26, 'ILMU', '1', '50', '', 'Once', 'on', '2022-04-18', '30', 'Matematik Tahun 2', '2022-04-18', '2022-04-07', 'test', ''),
(27, 'ILMU', '1', '50', '', 'Once', 'on', '2022-04-18', '30', 'Matematik Tahun 2', '2022-04-18', '2022-04-07', 'test', ''),
(28, 'ILMU', '1', '54', '', 'Once', 'on', '2022-03-29', '30', 'Pendidikan Islam Tahun 1', '2022-03-29', '2022-04-07', '', ''),
(34, 'ILMU', '2', '', '35', 'Once', 'on', '2022-04-11', '30', 'Pendidikan Jasmani & Pendidikan Kesihatan Tahun 1', '2022-04-11', '2022-04-07', 'alif', 'APPROVED'),
(36, '', '', '', '', '', '', '', '', '', '0000-00-00', '2022-04-07', '', ''),
(37, '', '', '', '', '', '', '', '', '', '0000-00-00', '2022-04-07', '', ''),
(39, '', '', '', '', '', '', '', '', '', '0000-00-00', '2022-04-07', '', ''),
(41, '', '', '', '', '', '', '', '', '', '0000-00-00', '2022-04-26', '', '');
...
--
-- Indexes for table `ownership_instructor`
--
ALTER TABLE `ownership_instructor`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `pemilikan_kerajaan`
--
ALTER TABLE `pemilikan_kerajaan`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `profit_manager`
--
ALTER TABLE `profit_manager`
  ADD PRIMARY KEY (`no`);
...
--
-- AUTO_INCREMENT for table `ownership_instructor`
--
ALTER TABLE `ownership_instructor`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `pemilikan_kerajaan`
--
ALTER TABLE `pemilikan_kerajaan`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `profit_manager`
--
ALTER TABLE `profit_manager`
