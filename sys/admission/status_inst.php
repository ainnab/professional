...
if(isset($_SESSION['ic']))
{
  $login_session=$_SESSION['ic'];
    ...
    $sql_query="select * from student where stud_ic='$login_session' ";
...
include 'header_inst.php';
 ...
 $sql1 = "SELECT status FROM `inst` where inst_name='$name'";
  $institusi = mysqli_query($dbconfig,$sql1);

   $data = mysqli_fetch_array($institusi,MYSQLI_ASSOC);
 ...
 ?>
      <div class="az-content-header d-block d-md-flex">
        <div>
          <h2 class="az-content-title tx-24 mg-b-5 mg-b-lg-8">Application Status</h2>
