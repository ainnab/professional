      ...
      <div class="row">
        <div class="border-bottom-1 border-grey-300 padding-10">
          <ol class="breadcrumb">
            ...
            <li class="active"> > PROFESSIONAL DIPLOMA IN COMPETENCY BASED TALENT MANAGEMENT</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend>COMPETENCY BASED TALENT MANAGEMENT</legend>
        
        <div class="post post-md">
          <div class="row">
            <div class="col-md-4">
              <div class="post-thumbnail">
                <img src="img/pd_competency.png"  width="460" height="345" alt="Core Module">
              </div>
            </div>
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>CONCEPTUALISING CBTM IN MANAGING HUMAN RESOURCES</h4>
                    <ul class="post-meta">
        ...
        <div class="post post-md">
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>DEVELOPING COMPETENCY BASED WORKFORCE PLANNING</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
        ...
        <div class="post post-md">
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>DESIGNING COMPETENCY BASED JOB DESCRIPTION & JOB PROFILING</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <input class="form-control" id="namaProgram" name="namaProgram" value="PROFESSIONAL DIPLOMA IN COMPETENCY BASED TALENT MANAGEMENT" hidden>
        <b><div>PROFESSIONAL DIPLOMA IN COMPETENCY BASED TALENT MANAGEMENT</div></b><br>
