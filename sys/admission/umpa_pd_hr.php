    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend>HUMAN RESOURCES MANAGEMENT</legend>
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <input class="form-control" id="namaProgram" name="namaProgram" value="PROFESSIONAL DIPLOMA IN HUMAN RESOURCES MANAGEMENT" hidden>
        <b><div>PROFESSIONAL DIPLOMA IN HUMAN RESOURCES MANAGEMENT</div></b><br>
