      ...
      <div class="row">
        <div class="border-bottom-1 border-grey-300 padding-10">
          <ol class="breadcrumb">
            ...
            <li class="active"> > EXECUTIVE BACHELOR IN TECHNOLOGY AND MANAGEMENT IN OIL & GAS</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend class="bd-b">TECHNOLOGY AND MANAGEMENT IN OIL & GAS</legend>
        ...
        <div class="post post-md">
          ...
          <div class="col-md-8">
            ...
            <p class="more text_justify">Organizational Behaviour Is Defined As The Study Of Human Behaviours In Organizational Settings,
               The Interface Between Human Behaviours And The Organizational Context And The Organizational Itself. </p>
          </div>
          </div>
        </div>
        <div class="post post-md">
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>STRATEGIC MANAGEMENT & CORPORATE TRANSFORMATION</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
            ...
            <p class="more text_justify">This Module Aims To Enhance Participants' Understanding Of The Strategic Management In
              An Organization That Creates The Competitive Advantages In Responding To The Internal And External Environment.</p>
          </div>
          </div>
        </div>
        <div class="post post-md">
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <input class="form-control" id="namaProgram" name="namaProgram" value="PROFESSIONAL DIPLOMA IN OIL AND GAS TECHNOLOGY" hidden>
        <b><div>EXECUTIVE BACHELOR IN TECHNOLOGY AND MANAGEMENT IN OIL & GAS</div></b><br>
