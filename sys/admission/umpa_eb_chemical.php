      ...
      <div class="row">
        <div class="border-bottom-1 border-grey-300 padding-10">
          <ol class="breadcrumb">
            ...
            <li class="active"> > EXECUTIVE BACHELOR IN CHEMICAL PROCESS PLANT</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend class="bd-b">CHEMICAL PROCESS PLANT</legend>
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>INTRODUCTION TO CHEMICAL PROCESS PLANT</h4>
                    <ul class="post-meta">
        ...
        <div class="post post-md">
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>PRINCIPLES OF CHEMICAL EQUILIBRIUM</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
        ...
        <div class="post post-md">
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>THERMODYNAMICS AND FLUID FLOW</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <input class="form-control" id="namaProgram" name="namaProgram" value="EXECUTIVE BACHELOR IN CHEMICAL PROCESS PLANT" hidden>
        <b><div>EXECUTIVE BACHELOR IN CHEMICAL PROCESS PLANT</div></b><br>
