      ...
      <div class="row">
        <div class="border-bottom-1 border-grey-300 padding-10">
          <ol class="breadcrumb">
            ...
            <li class="active"> > EXECUTIVE BACHELOR IN SUPPLY CHAIN MANAGEMENT</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend class="bd-b">SUPPLY CHAIN MANAGEMENT</legend>
        ...
        <div class="post post-md">
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>PROCUREMENT AND SOURCING</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
        ...
        <div class="post post-md">
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>CUSTOMISED LOGISTIC ARRANGEMENT</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <input class="form-control" id="namaProgram" name="namaProgram" value="EXECUTIVE BACHELOR IN SUPPLY CHAIN MANAGEMENT" hidden>
        <b><div>EXECUTIVE BACHELOR IN SUPPLY CHAIN MANAGEMENT</div></b><br>
