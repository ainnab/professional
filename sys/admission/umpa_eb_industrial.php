      ...
      <div class="row">
        <div class="border-bottom-1 border-grey-300 padding-10">
          <ol class="breadcrumb">
            ...
            <li class="active"> > EXECUTIVE BACHELOR IN INDUSTRIAL OPERATION MANAGEMENT</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend class="bd-b">INDUSTRIAL OPERATION MANAGEMENT</legend>
          ...
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>INDUSTRIAL RISK MANAGEMENT</h4>
                    <ul class="post-meta">
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <input class="form-control" id="namaProgram" name="namaProgram" value="EXECUTIVE BACHELOR IN INDUSTRIAL OPERATION MANAGEMENT" hidden>
        <b><div>EXECUTIVE BACHELOR IN INDUSTRIAL OPERATION MANAGEMENT</div></b><br>
