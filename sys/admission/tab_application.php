    ...
    ?>
      ...
      <div class="row row-sm">
        <div class="col-md-12 col-lg-12 col-xl-6">
          ...
          <select class="form-control" id="" name="pgFirst">
          <option value="" selected disabled="" style="font-size:14px;">Please select</option>
                              <?php
                                  $sql4 = "SELECT * FROM program WHERE pg_code != 'A' && pg_code != 'PREDIP' && pg_code != 'DIP'";
                              ...
                              <?php }	?>
                              <?php
                                  $sql4 = "SELECT * FROM program_diploma";
                                  $result4 = mysqli_query($dbconfig, $sql4) or die("database error:". mysqli_error($dbconfig));
                                  while( $row4 = mysqli_fetch_assoc($result4) ) {
                                      $pgCode=$row4['pg_code'];
                                      $pgName=strtolower($row4['pg_name']);
      ...
      <div class="row row-sm">
        <div class="col-md-12 col-lg-12 col-xl-6">
          ...
          <select class="form-control" id="" name="pgSecond">
          <option value="" selected disabled="" style="font-size:14px;">Please select</option>
                              <?php
                                  $sql4 = "SELECT * FROM program WHERE pg_code != 'A' && pg_code != 'PREDIP' && pg_code != 'DIP'";
                                  $result4 = mysqli_query($dbconfig, $sql4) or die("database error:". mysqli_error($dbconfig));
      ...
      <div class="row row-sm">
        <div class="col-md-12 col-lg-12 col-xl-6">
          ...
          <select class="form-control" id="" name="pgThird">
          <option value="" selected disabled="" style="font-size:14px;">Please select</option>
                              <?php
                                  $sql4 = "SELECT * FROM program WHERE pg_code != 'A' && pg_code != 'PREDIP' && pg_code != 'DIP'";
                                  $result4 = mysqli_query($dbconfig, $sql4) or die("database error:". mysqli_error($dbconfig));
