      ...
      <div class="az-sidebar-body">
        <ul class="nav">
          ...
          <li class="nav-item show current">
            ...
            <ul class="nav-sub">
              <li class="nav-sub-item <?php echo (basename($_SERVER['PHP_SELF']) == 'tab_inst.php' ?'active' : " ");?>"><a href="tab_inst.php" class="nav-sub-link ">Application</a></li>
               <li class="nav-sub-item <?php echo (basename($_SERVER['PHP_SELF']) == 'status_inst.php' ?'active' : " ");?>"><a href="status_inst.php" class="nav-sub-link ">Status</a></li>
