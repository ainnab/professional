    ...
    <div class="az-sidebar">
      ...
      <div class="az-sidebar-body">
        ...
        <li class="nav-label">Main Menu</li>
          ...
          <a href="dashboard3.php" class="nav-link"><i class="typcn typcn-clipboard"></i>Student</a>
           <ul class="nav-sub">
          ...
          <li class="nav-item show current">
           ...
           <li class="nav-item show current">
            <a href="tab_program.php" class="nav-link with-sub"><i class="typcn typcn-clipboard"></i>Institution</a>
            <ul class="nav-sub">
              <li class="nav-sub-item <?php echo (basename($_SERVER['PHP_SELF']) == 'list_application_inst.php' ?'active' : " ");?>"><a href="list_application_inst.php" class="nav-sub-link ">List of Application</a></li>
