      ...
      <div class="row">
        <div class="border-bottom-1 border-grey-300 padding-10">
          <ol class="breadcrumb">
            ...
            <li class="active"> > PROFESSIONAL DIPLOMA IN INDUSTRIAL TECHNOLOGY MANAGEMENT</li>
          </ol>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12 padding-right-22">
          <legend>INDUSTRIAL TECHNOLOGY MANAGEMENT</legend>
        
        <div class="post post-md">
          <div class="row">
            <div class="col-md-4">
              <div class="post-thumbnail">
                <img src="img/pd_ee.png"  width="460" height="345" alt="Core Module">
              </div>
            </div>
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>COMPUTING FUNDAMENTAL AND APPLICATION PACKAGES</h4>
                    <ul class="post-meta">
        ...
        <div class="post post-md">
          <div class="row">
            <div class="col-md-4">
              <div class="post-thumbnail">
                <img src="img/pd_ee1.png"  width="460" height="345" alt="Core Module">
              </div>
            </div>
          <div class="col-md-8">
              <div class="post-header">
                <div class="post-title">
                  <h4>MANUFACTURING & OPERATION MANAGEMENT</h4>
                    <ul class="post-meta">
                    <li><span class="label label-success"><i class="fa fa-bookmark" aria-hidden="true"></i> Core Module</span></li>
                    <li><i class="fa fa-clock-o" aria-hidden="true"></i> 16 Hours</li>
                    <li><i class="fa fa-barcode" aria-hidden="true"></i> UTG01</li>
        ...
        <div class="post post-md">
          <div class="row">
            <div class="col-md-4">
              <div class="post-thumbnail">
                <img src="img/pd_ee2.png"  width="460" height="345" alt="Core Module">
              </div>
            </div>
          <div class="col-md-8">
              <div class="post-header">
  ...
  <div class="form-wrapper"></div>
    <div class="overlay" >
       ...
       <div class="card card-dashboardseven">
        ...
        <input class="form-control" id="namaProgram" name="namaProgram" value="PROFESSIONAL DIPLOMA IN INDUSTRIAL TECHNOLOGY MANAGEMENT" hidden>
        <b><div>PROFESSIONAL DIPLOMA IN INDUSTRIAL TECHNOLOGY MANAGEMENT</div></b><br>
        <b><div class="bold text-uppercase margin-top-35">Created:</b>
        <span class="font-size-13">Mar 24, 2022 </span></div><br>
