...
if ($role == 'student' ){?>
        ...
        <ul class="nav">
          ...
          <li class="nav-item show">
            ...
            <li class="nav-sub-item"><a href="master_exec_stud.php" class="nav-sub-link">Master Eksekutif</a></li> <li class="nav-sub-item"><a href="bach_exec_stud.php" class="nav-sub-link">Bachelor Eksekutif</a></li> 
