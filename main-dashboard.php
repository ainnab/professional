  ...
  $login_session=$_SESSION['username'];
    //$path_session=$_SESSION['path'];
     ...
     $sql_query="SELECT u.username as username,u.firstname,u.lastname, u.email, cc.name as institution ,r.name as rolename, cc.id as inst_id, ra.roleid,ra.userid
        ...
        where u.username = '$login_session' and cc.id!='44'";
      ...
      <div class="az-content-header">
        <div class="az-content-header-top">
          <div>
            ...
            <div class="weight-600 font-30 text-blue"><?php echo $username; ?></div>
             <div class="weight-600 font-30 text-blue"><?php echo  $institution; ?></div>
          ...
          <div class="az-content-body">
			...
			elseif(($userRole == '3')) {
				include 'courseowner_dashboard.php';
			} 
			elseif(($userRole == '9')) {
