  ...
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="row row-xs wd-xl-80p">
        <div class="col-sm-6 col-md-3"><button class="btn btn-success btn-with-icon btn-block" onclick="location.href='add_profit.php'"><i class="typcn typcn-edit"></i>ADD NEW PROFIT</button></div>
...
$i = 0;
                    ...
                    $sql3="SELECT profit.id_profit,contract_info.contract_id,contract_info.institusi,profit.earn_mooc,profit.earn_ins,profit.date_today,contract_info.status FROM `profit` left outer join contract_info on contract_info.contract_id=profit.contract_info ";
...
$i++;
                      ...
                      $id_profit = $row1['id_profit'];
                        $contract_id = $row1['contract_id'];
                     // $id = $row1['userid'];
                      $institusi = $row1['institusi'];
                      $earn_mooc = $row1['earn_mooc'];
                         $earn_ins = $row1['earn_ins'];
                ...
                <tr>
                 <td class="table-plus"><?php echo $i;?></td>
                  <td><?php echo $id_profit;?></td>
                 
                  <td><?php echo  $contract_id;?></td>
                  <td><?php echo $institusi;?></td>
                  <td><?php echo $earn_mooc;?>-<?php echo $earn_ins;?></td>
