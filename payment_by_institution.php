		  ...
		  <div class="col-xl-12 mg-t-15 mg-t-20">
            <div class="card">
              <div class="card-header">
                <h6 class="card-title tx-14 mg-b-5">All Payment Record as Institution</h6>
              ...
              <div class="card-body">
                <div class="table-responsive">
					<table id="example1" class="table table-striped mg-b-0">
					  ...
					  <?php
						$sql_query2="SELECT distinct ep.txn_id , c.fullname as txn,FROM_UNIXTIME(ep.timeupdated) as purchase_date,e.cost ,ep.payment_status FROM mdl_enrol_paypal as ep join mdl_course as c ON ep.courseid = c.id join mdl_course_categories AS cc ON c.category = cc.id LEFT JOIN mdl_context AS ctx ON c.id = ctx.instanceid JOIN mdl_role_assignments AS tra ON tra.contextid = ctx.id join mdl_user as us on us.id=tra.userid join mdl_enrol as e on e.courseid=c.id WHERE us.username='$login_session' and e.cost is not null;  ";
            ...
            $cost = $userRow2['cost'];
					...
					?>
					  <tbody>
						...
						<tr>
						  ...
						  <td><a href="receipt.php?payment_id=<?php echo $payment_id?>"><button class="btn btn-outline-indigo btn-block">Receipt</button></a></td>
						</tr>
				...
				<div class="row row-xs wd-xl-80p">
					<div class="col-sm-6 col-md-3"><button class="btn btn-outline-indigo btn-block">Print</button></div>
				</div><!-- row -->
              </div><!-- card-body -->
            </div><!-- card -->
          </div><!-- col -->
