  ...
  <body class="az-body az-body-sidebar az-body-dashboard-nine">
    ...
    <div class="az-content az-content-dashboard-nine">
      ...
      <div class="col-xl-12 mg-t-15 mg-t-20">
        ...
        $sql_query2="SELECT u.username as student,u.id,ROUND(gg.finalgrade,2) as grade FROM mdl_grade_items AS gi INNER JOIN mdl_course c ON c.id = gi.courseid LEFT JOIN mdl_grade_grades AS gg ON gg.itemid = gi.id INNER JOIN mdl_user AS u ON gg.userid = u.id WHERE  gi.itemtype = 'course' and c.id='$cid' and u.username!='admin'";
      ...
      ?>
              <tbody>
                <tr>  <td><?php echo $student;?></td>
                  ...
                  <td><a href="verify_studentsMark.php" ><button name="update" class="btn btn-primary btn-md">Verify Mark</button></a></td>
